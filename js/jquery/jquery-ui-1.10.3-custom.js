!(function (t, e) {
    ...
    (t.cleanData = function (e) {
      ...
      (t.widget = function (i, s, n) {
        ...
        (o = c + "-" + (i = i.split(".")[1])),
          ...
          ((h = new s()).options = t.widget.extend({}, h.options)),
  ...
  (function (t, e) {
    ...
    (t.position = {
        ...
        return (
          (v =
            9 === (b = ($ = y)[0]).nodeType
              ...
              ? {
                  width: $.width(),
                  height: $.height(),
                  offset: { top: $.scrollTop(), left: $.scrollLeft() },
                }
              : b.preventDefault
          ...
          t.each(["my", "at"], function () {
            ...
            1 === s.length &&
              ...
              (e[this] = [u.exec(s[0])[0], u.exec(s[1])[0]]);
          }),
          1 === k.length && (k[1] = k[0]),
          "right" === e.at[0]
            ? (m.left += d)
          ...
          this.each(function () {
            var h,
              ...
              v = s(this, "marginLeft"),
              $ = s(this, "marginTop"),
              b = u + v + s(this, "marginRight") + w.width,
              C = p + $ + s(this, "marginBottom") + w.height,
              D = t.extend({}, m),
              P = i(x.my, c.outerWidth(), c.outerHeight());
            "right" === e.my[0]
              ? (D.left -= u)
              : "center" === e.my[0] && (D.left -= u / 2),
              "bottom" === e.my[1]
                ? (D.top -= p)
                : "center" === e.my[1] && (D.top -= p / 2),
              (D.left += P[0]),
              (D.top += P[1]),
              t.support.offsetFractions ||
                ((D.left = r(D.left)), (D.top = r(D.top))),
              (h = { marginLeft: v, marginTop: $ }),
              ...
              e.using &&
                (l = function (t) {
                  ...
                  u > d && d > a(i + s) && (h.horizontal = "center"),
                    p > f && f > a(n + r) && (h.vertical = "middle"),
                    (h.important =
                      o(a(i), a(s)) > o(a(n), a(r))
                        ? "horizontal"
                        : "vertical"),
        ...
        flip: {
          ...
          top: function (t, e) {
            var i,
              ...
              f = -2 * e.offset[1];
            0 > c
              ? ((s = t.top + d + p + f + e.collisionHeight - r - o),
                t.top + d + p + f > c &&
                  (0 > s || a(c) > s) &&
                  (t.top += d + p + f))
              : u > 0 &&
      ...
      (function () {
        ...
        for (o in ((e = document.createElement(a ? "div" : "body")),
        (s = {
          visibility: "hidden",
          width: 0,
          height: 0,
      ...
      _create: function () {
        ...
        if (
          ...
          for (
            ...
            (o = "ui-resizable-" + (s = t.trim(e[i]))),
              (n = t("<div class='ui-resizable-handle " + o + "'></div>")).css({
                zIndex: r.zIndex,
              }),
        ...
        if (f) {
          if (1 === this.containers.length)
            ...
            for (
              a = 1e4,
                r = null,
                h = (p = f.floating || i(this.currentItem)) ? "left" : "top",
                l = p ? "width" : "height",
        ...
        null === l.label &&
          ...
          this.buttonElement
            ...
            .bind("mouseenter" + this.eventNamespace, function () {
              l.disabled || (this === e && t(this).addClass("ui-state-active"));
            })
            .bind("mouseleave" + this.eventNamespace, function () {
              l.disabled || t(this).removeClass(u);
            })
            .bind("click" + this.eventNamespace, function (t) {
              l.disabled && (t.preventDefault(), t.stopImmediatePropagation());
            }),
          this.element
          ...
          c &&
            ...
            this.buttonElement
              .bind("mousedown" + this.eventNamespace, function (t) {
                l.disabled || ((n = !1), (i = t.pageX), (s = t.pageY));
              })
              .bind("mouseup" + this.eventNamespace, function (t) {
                l.disabled || ((i !== t.pageX || s !== t.pageY) && (n = !0));
              })),
          "checkbox" === this.type
            ? this.buttonElement.bind(
                "click" + this.eventNamespace,
                function () {
                  return !l.disabled && !n && void 0;
                }
              )
            : "radio" === this.type
            ? this.buttonElement.bind(
            ...
            : (this.buttonElement
                .bind("mousedown" + this.eventNamespace, function () {
                  return (
                    ...
                    (t(this).addClass("ui-state-active"),
                    (e = this),
                    void a.document.one("mouseup", function () {
                      e = null;
                    }))
                  );
                })
                .bind("mouseup" + this.eventNamespace, function () {
                  return (
                    !l.disabled && void t(this).removeClass("ui-state-active")
                  );
                })
    ...
    t.extend(i.prototype, {
      ...
      parseDate: function (i, s, n) {
        ...
        if (
          ...
          for (v = 1, $ = b; !((a = this._getDaysInMonth(m, v - 1)) >= $); )
            v++, ($ -= a);
        if (
      ...
      _generateHTML: function (t) {
        ...
        for (
          ...
          for (k = "", this.maxRows = 4, x = 0; U[1] > x; x++) {
            if (
            ...
            for (
              P +=
                ...
                D +
                "'>" +
                (/all|left/.test(D) && 0 === w ? (Y ? o : s) : "") +
                (/all|right/.test(D) && 0 === w ? (Y ? s : o) : "") +
            ...
            for (
              P += T + "</tr></thead><tbody>",
                ...
                z = Math.ceil(
                  ((M = (this._getFirstDayOfMonth(tt, Z) - c + 7) % 7) + S) / 7
                ),
              ...
              for (
                ...
                (N = m ? m.apply(t.input ? t.input[0] : null, [A]) : [!0, ""]),
                  (F =
                    ((O = A.getMonth() !== Z) && !$) ||
                    !N[0] ||
                    (Q && Q > A) ||
                  ...
                  (E +=
                    ...
                    ((A.getTime() === C.getTime() &&
                      Z === t.selectedMonth &&
                      t._keyEvent) ||
                    (b.getTime() === A.getTime() && b.getTime() === C.getTime())
                      ? " " + this._dayOverClass
                      : "") +
                    (F
      ...
      _generateMonthYearHeader: function (t, e, i, s, n, o, a, r) {
        var h,
          ...
          $ = this._get(t, "showMonthAfterYear"),
            ...
            (h = !1),
              ...
              (s =
                a && -1 !== s.index(this.active.next())
                  ...
                  : s).length ||
                ((r = RegExp(
                  "^" + i((o = String.fromCharCode(e.keyCode))),
                  "i"
                )),
                (s = this.activeMenu
                  .children(".ui-menu-item")
          ...
          switch (
            ...
            case t.ui.keyCode.PAGE_UP:
              n = this._trimAlignValue(
                s + (this._valueMax() - this._valueMin()) / 5
              );
              break;
            case t.ui.keyCode.PAGE_DOWN:
              n = this._trimAlignValue(
  ...
  (function (t, e) {
    function i(t) {
      return (
        t.hash.length > 1 &&
        decodeURIComponent(t.href.replace(n, "")) ===
    ...
    t.widget("ui.tabs", {
      ...
      load: function (e, s) {
        ...
        var n = this,
          ...
          h = { tab: o, panel: r };
        i(a[0]) ||
          ((this.xhr = t.ajax(this._ajaxSettings(a, s, h))),
          this.xhr &&
  ...
  (function (t) {
    ...
    t.widget("ui.tooltip", {
      ...
      _open: function (e, i, s) {
        function n(t) {
          (u.of = t), h.is(":hidden") || h.position(u);
        }
        var o,
          a,
          r,
        ...
        if (s) {
          if ((h = this._find(i)).length)
            return void h.find(".ui-tooltip-content").html(s);
          i.is("[title]") &&
            (e && "mouseover" === e.type
              ? i.attr("title", "")
              : i.removeAttr("title")),
            ...
            (o = i),
            (a = h.attr("id")),
            (r = (o.attr("aria-describedby") || "").split(/\s+/)).push(a),
            o
              .data("ui-tooltip-id", a)
              .attr("aria-describedby", t.trim(r.join(" "))),
            h.find(".ui-tooltip-content").html(s),
            this.options.track && e && /^mouse/.test(e.type)
              ? (this._on(this.document, { mousemove: n }), n(e))
              : h.position(t.extend({ of: i }, this.options.position)),
            h.hide(),
            ...
            this.options.show &&
              ...
              (c = this.delayedShow =
                setInterval(function () {
                  h.is(":visible") && (n(u.of), clearInterval(c));
                }, t.fx.interval)),
            this._trigger("open", e, { tooltip: h }),
            (l = {
              keyup: function (e) {
            ...
            (e && "mouseover" !== e.type) || (l.mouseleave = "close"),
            (e && "focusin" !== e.type) || (l.focusout = "close"),
            this._on(!0, i, l);
        }
      },
      close: function (e) {
    ...
    (t.effects = { effect: {} }),
      ...
      (function () {
        ...
        t.each(
          ...
          (t.effects.animateClass = function (e, s, n, o) {
            var h = t.speed(s, n, o);
            ...
            removeClass:
              ...
              function (e, i, s, o) {
                return arguments.length > 1
                  ? t.effects.animateClass.call(this, { remove: e }, i, s, o)
                  : n.apply(this, arguments);
              }),
            toggleClass:
              ((o = t.fn.toggleClass),
      ...
      (function () {
        ...
        t.extend(t.effects, {
          ...
          restore: function (t, i) {
            ...
            for (o = 0; i.length > o; o++)
              null !== i[o] &&
                ((n = t.data(s + i[o])) === e && (n = ""), t.css(i[o], n));
          },
    ...
    t.effects.effect.bounce = function (e, i) {
      ...
      for (
        ...
        ((n = {})[v] = ($ ? "-=" : "+=") + d),
          ...
          (d = l ? 2 * d : d / 2);
      l &&
        (((n = { opacity: 0 })[v] = ($ ? "-=" : "+=") + d), a.animate(n, g, m)),
        a.queue(function () {
          l && a.hide(),
  ...
  (function (t) {
    t.effects.effect.pulsate = function (e, i) {
      ...
      n.animate({ opacity: c }, l, e.easing),
        ...
        d > 1 && u.splice.apply(u, [1, 0].concat(u.splice(d, h + 1))),
        n.dequeue();
    };
  })(jQuery),
  (function (t) {
  ...
  (function (t) {
    t.effects.effect.shake = function (e, i) {
      ...
      n
        ...
        $ > 1 && v.splice.apply(v, [1, 0].concat(v.splice($, c + 1))),
        n.dequeue();
    };
  })(jQuery),
  (function (t) {
